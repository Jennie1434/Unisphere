      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-white/50 backdrop-blur-sm py-12 px-4 text-black">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-black/60 font-sans">
            ...
            {loading ? (
              ...
              <div className="divide-y divide-gray-200">
                {notifications.map((notif) => (
                  <div
                    key={notif.id}
                    className={`p-6 hover:bg-gray-50 transition-colors ${!notif.read ? 'bg-blue-50 border-l-4 border-blue-500' : ''
                      }`}
                  >
