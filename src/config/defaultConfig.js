      ...
      fields: [
        {
          name: "link",
          type: "url",
          label: "Lien du témoignage (vidéo ou article)",
          placeholder: "https://...",
          required: false
        },
        {
          name: "description",
          type: "textarea",
          label: "Description du témoignage",
      ...
      fields: [
        {
          name: "parrainedEmail",
          type: "email",
          label: "Email de l'étudiant parrainé",
        ...
        },
        {
          name: "parrainedName",
          type: "text",
          label: "Nom de l'étudiant parrainé",
        ...
        },
        {
          ...
          placeholder: "Informations sur le parrainage...",
          required: false
        }
      ]
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "rank",
          type: "text",
          label: "Classement obtenu",
          placeholder: "1ère place, 2ème place, etc.",
          required: true
        },
        {
          name: "teamName",
